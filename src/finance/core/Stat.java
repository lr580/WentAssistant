...
public class Stat {// 统计
    ...
    public static void stat() {
        ...
        // cat = new StatTree(Cata.query(DbLoad.getTypex()), false);
        ...
        for (int i = 0; i < n; ++i) {
            ...
            sum += ov;
            Date d = Supply.date2TDate(Tabbar.date[i]);
            cld.setTime(d);
        ...
        res.append("平均金额: " + sdf.format(avg) + "\n");
